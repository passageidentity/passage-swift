...
open class OAuth2API {
    ...
    /**
     ...
     - parameter loginHint: (query) Hint to the Authorization Server about the login identifier the end-user might use to log in. (optional)
     - returns: Void
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func getAuthorize(appId: String, redirectUri: String, codeChallenge: String, codeChallengeMethod: String, connectionType: ConnectionType_getAuthorize, state: String? = nil, loginHint: String? = nil) async throws {
        return try await getAuthorizeWithRequestBuilder(appId: appId, redirectUri: redirectUri, codeChallenge: codeChallenge, codeChallengeMethod: codeChallengeMethod, connectionType: connectionType, state: state, loginHint: loginHint).execute().body
    }
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    open class func getAuthorizeWithRequestBuilder(appId: String, redirectUri: String, codeChallenge: String, codeChallengeMethod: String, connectionType: ConnectionType_getAuthorize, state: String? = nil, loginHint: String? = nil) -> RequestBuilder<Void> {
        ...
        localVariableUrlComponents?.queryItems = APIHelper.mapValuesToQueryItems([
            ...
            "login_hint": (wrappedValue: loginHint?.encodeToJSON(), isExplode: true),
